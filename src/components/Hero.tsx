          ...
          <div className="lg:col-span-5 order-2 lg:order-1">
            <motion.div style={{ opacity }}>
              ...
              <div className="flex flex-col gap-4">
                <button className="flex justify-between items-center w-full max-w-xs py-4 border-b-2 border-black group">
                  <span className="font-serif font-bold text-xl group-hover:text-burgundy transition-colors">The Ventures</span>
                  <span className="group-hover:translate-x-2 transition-transform">→</span>
                </button>
                <button className="flex justify-between items-center w-full max-w-xs py-4 border-b border-black/10 group">
